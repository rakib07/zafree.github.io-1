...
(function () {
  ...
  function renderOriginalImage(image) {
    window.addEventListener('load', function () {
      ...
      image_origanal.onload = function () {
        ...
        image_origanal.alt = image_alt; // image_origanal.title = image_title;
      };
    });
  } // all image
  ...
  function hasImage(image) {
    ...
    var imageWidth = image.getAttribute('data-width'),
        ...
        imageAlt = image.getAttribute('data-alt'); // imageTitle = image.getAttribute('data-title');
...
(function () {
  'use strict'; // document.querySelectorAll("nav button").forEach((btn, index) => {
